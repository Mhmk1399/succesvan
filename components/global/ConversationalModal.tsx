  ...
  const { isRecording, isProcessing, toggleRecording } = useVoiceRecording({
    onTranscriptionComplete: async (result) => {
      ...
      if (response) {
        ...
        console.log("🎯 [Conversational Modal] Is complete:", response.isComplete);
        console.log("🔍 [Conversational Modal] Missing:", response.missingFields);
        ...
        console.log("✅ [Conversational Modal] All fields filled:", allFieldsFilled);
