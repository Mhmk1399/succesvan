          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Hire a van in Hendon with Success Van Hire at highly competitive
                rates. Perfect for removals, moving home, large furniture, IKEA
                purchases, and more. Book your automatic van today!
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      ...
                      Cross Shopping Centre - Easy access from Hendon
                    </p>
                  </div>
                </div>
              </div>
