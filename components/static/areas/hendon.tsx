...
const faqData = [
  ...
  {
    question: "How do I book a van hire in Hendon?",
    answer:
  ...
  {
    question: "What do I need to rent a van in Hendon?",
    answer:
...
export default function HendonVanHire() {
  ...
  const testimonials = [
    {
      name: "Tom H.",
      rating: 5,
      text: "Brilliant service! Hired a van for a house move in Hendon. The team at Success Van Hire were professional and the van was in excellent condition. Highly recommend!",
      location: "Hendon",
    },
    {
      name: "Sophie R.",
      rating: 5,
      text: "Great van hire experience in NW London. Affordable prices, clean vehicles, and excellent customer service. Will definitely use Success Van Hire again!",
      location: "Mill Hill",
    },
    {
      name: "Daniel K.",
      rating: 5,
      text: "Needed a van urgently for a business delivery. Success Van Hire had availability and the booking process was quick and easy. Top-notch service!",
  ...
  // Service areas
  const serviceAreas = [
    { name: "Mill Hill", link: "/van-hire-mill-hill", featured: true },
    { name: "Golders Green", link: "/van-hire-golders-green" },
    { name: "Hampstead", link: "/van-hire-hampstead" },
    { name: "Camden", link: "/van-hire-camden" },
  ...
  return (
    <>
      <Head>
        <title>Van Hire Hendon | Success Van Hire - Cheap & Reliable North London Van Rental</title>
        <meta
          name="description"
          content="Need van hire in Hendon? Success Van Hire offers affordable van rental near Hendon Central. ULEZ compliant, no hidden fees, 5-star service. Book online or call 020 3011 1198."
        />
        <meta
          name="keywords"
          content="van hire hendon, van rental hendon london, hendon van hire, north london van rental, success van hire hendon"
        />
        <link rel="canonical" href="https://www.successvanhire.com/van-hire-hendon" />
      </Head>
      ...
      <div ref={sectionRef} className="relative w-full bg-[#0f172b] py-28">
        ...
        <section className="relative">
          ...
          <div className="relative w-full h-[50vh] sm:h-[60vh] lg:h-[70vh] overflow-hidden">
            ...
            <Image
              src="/assets/images/van hire in hendon.png"
              alt="Van Hire Hendon - Success Van Hire modern fleet of vans in Hendon"
              fill
              ...
              <div className="space-y-6 lg:space-y-8">
                <div>
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#fe9a00]/10 border border-[#fe9a00]/30 mb-4">
                    ...
                    <span className="text-[#fe9a00] font-bold text-xs sm:text-sm">HENDON</span>
                  </div>
                ...
                <div className="space-y-4">
                  <p className="text-lg sm:text-xl text-gray-200 leading-relaxed">
                    Reliable <strong className="text-white">van hire in Hendon</strong> with Success Van Hire at competitive rates. Perfect for house removals, furniture delivery, business logistics, and IKEA collections. Searching for <Link href="/van-hire-london" className="text-[#fe9a00] hover:underline font-semibold">van hire London</Link>? We provide <Link href="/cheap-van-hire-london" className="text-[#fe9a00] hover:underline font-semibold">cheap van hire London</Link> with exceptional service.
                  </p>

                  <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
                    Ideally located near Hendon Central, serving all NW London areas with excellent access. From small vans for local deliveries to <Link href="/luton-van-hire-london" className="text-[#fe9a00] hover:underline font-semibold">Luton van hire London</Link> for full house moves, our fleet meets all requirements. Looking for <Link href="/removal-van-hire-london" className="text-[#fe9a00] hover:underline font-semibold">removal van hire London</Link>? We provide flexible hourly, daily, weekly, and monthly <strong>Hendon van hire</strong> solutions.
                  </p>

                  <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
                    As your dedicated <strong>North London van rental</strong> provider, we run a modern fleet that's fully ULEZ and LEZ compliant. All vehicles are regularly serviced and professionally cleaned. Trust <strong>success van hire hendon</strong> for reliable, professional van rental across North London.
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                Your trusted partner for affordable van rental in Hendon
              </p>
            </div>
        ...
        <section className="relative py-20 border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                Real feedback from satisfied van hire customers in Hendon
              </p>
            </div>
        ...
        <section className="relative py-20 border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-4">
                Serving <span className="text-[#fe9a00]">Hendon</span> & Beyond
              </h2>
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {serviceAreas.map((area, index) => (
                <Link
                  ...
                  className={`group bg-linear-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:border-[#fe9a00]/30 transition-all duration-300 hover:scale-105 text-center ${area.featured ? "border-2 border-[#fe9a00]/30" : ""
                    }`}
                >
            ...
            <div className="mt-12 bg-blue-500/10 border border-blue-500/20 rounded-2xl p-6 text-center max-w-3xl mx-auto">
              ...
              <p className="text-gray-300">
                Our <strong>North London van rental</strong> service extends across Hendon, Mill Hill, Golders Green, Hampstead, and all NW postcodes. Need a van in another area? Just ask – we offer delivery options and one-way rentals.
              </p>
            </div>
          </div>
        </section>
        ...
        <FAQComponent
          ...
          subtitle="Find answers to common questions about our van hire services in Hendon"
          faqs={faqData}
          showSearch={false}
          defaultOpen={0}
          accentColor="#fe9a00"
              ...
              <div className="bg-linear-to-br from-[#0f172b] to-[#1e293b] rounded-3xl p-8 lg:p-12">
                <div className="text-center max-w-3xl mx-auto">
                  <h2 className="text-3xl lg:text-5xl font-black text-white mb-6">
                    Book Your Van Rental in Hendon Today
                  </h2>
                  <p className="text-gray-300 text-xl mb-8 leading-relaxed">
                    Get the best rates on van hire in Hendon. Whether you need a
                    van for a few hours or several weeks, we've got you covered!
                  </p>
