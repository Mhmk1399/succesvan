...
export default function NWLondonCarHire() {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-white font-bold mb-1">
                      Convenient Location in Staples Corner
                    </div>
                    <p className="text-gray-300 text-sm">
                      Just off the A406 Staples Corner junction, near Brent
                      Cross Shopping Centre - Serving all NW London areas
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-12">
            {areas.map((area, index) => (
              <div
                ...
                className="bg-linear-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:border-[#fe9a00]/30 transition-all duration-300 hover:scale-105 text-center"
              >
                <div className="w-10 h-10 rounded-lg bg-[#fe9a00]/20 flex items-center justify-center mx-auto mb-3">
                  <FiMapPin className="text-[#fe9a00]" />
                </div>
                <h4 className="text-white font-bold">{area}</h4>
              </div>
            ))}
            <div className="bg-linear-to-br from-[#fe9a00]/10 to-transparent border border-[#fe9a00]/20 rounded-xl p-6 text-center flex items-center justify-center">
              <span className="text-[#fe9a00] font-bold">& All NW London</span>
            </div>
          </div>
        </div>
      </section>
