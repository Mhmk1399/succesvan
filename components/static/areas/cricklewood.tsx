          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Book your van rental in Cricklewood with Success Van Hire at
                highly competitive rates. Perfect for removals, moving home,
                large furniture, IKEA purchases, and more.
              </p>
            ...
            <div className="bg-linear-to-br from-[#0f172b] to-[#1e293b] rounded-3xl p-8 lg:p-12">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-gray-300 text-xl mb-8 leading-relaxed">
                  Get the best rates on van hire in Cricklewood. Whether you
