          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-2xl font-bold text-gray-300 mb-6">
                Book Your Van Rental in Wembley
              </h2>

              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Hire a van in Wembley with Success Van Hire at highly
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      ...
                      Cross Shopping Centre - Easy access from Wembley
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Your trusted partner for affordable van rental in Wembley
            </p>
          </div>
            ...
            <div className="bg-linear-to-br from-[#0f172b] to-[#1e293b] rounded-3xl p-8 lg:p-12">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-gray-300 text-xl mb-8 leading-relaxed">
                  Get the best rates on van hire in Wembley. Whether you need a
