...
const faqData = [
  ...
  {
    question: "How do I book a van hire in Golders Green?",
    answer:
  ...
  {
    question: "What do I need to rent a van in Golders Green?",
    answer:
      "You need to provide: Your ID, a valid driving Licenses, proof of address, and your bank card. We accept full UK and EU driving licenses with quick and easy verification.",
    category: "Requirements",
  },
  {
  ...
  {
    question: "Do you have automatic vans available?",
    answer:
      "Yes! We have automatic vans available for hire. Perfect for drivers who prefer automatic transmission for a smooth and easy driving experience. Book online or call us for availability.",
    category: "Vehicles",
  },
  {
    question: "What types of vans do you offer for rental?",
    answer:
      "We offer Small Vans for light deliveries, Medium Vans for versatile cargo space, Large Vans for heavy-duty relocations with tail lift options, and Luton Vans for house moves with the largest capacity and climate control. Both automatic and manual transmission options available.",
    category: "Vehicles",
  },
  {
  ...
  return (
    <div ref={sectionRef} className="relative w-full bg-[#0f172b] py-28">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Your trusted partner for affordable van rental in Golders Green
            </p>
          </div>
            ...
            <div className="bg-linear-to-br from-[#0f172b] to-[#1e293b] rounded-3xl p-8 lg:p-12">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="w-24 h-24 rounded-2xl bg-white/10 flex items-center justify-center shrink-0">
                  <TbAutomaticGearbox className="text-[#fe9a00] text-5xl" />
                </div>
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-3xl font-black text-white mb-3">
                    Automatic Vans for Stress-Free Driving
                  </h3>
                  <p className="text-gray-300 text-lg mb-4">
                    Prefer an automatic? Our fleet includes a selection of
                    modern automatic vans, giving you a smooth and easy driving
                    experience—perfect for both new and seasoned drivers.
                  </p>
                ...
                <Link
                  href="/reservation"
                  className="px-8 py-4 rounded-xl bg-linear-to-r from-[#fe9a00] to-orange-500 text-white font-bold hover:scale-105 transition-all duration-300 flex items-center gap-2 whitespace-nowrap"
                >
                  <TbAutomaticGearbox className="text-xl" />
                  Book Automatic Van
                </Link>
              </div>
            </div>
      ...
      <FAQComponent
        ...
        subtitle="Find answers to common questions about our van hire services in Golders Green"
        faqs={faqData}
        showSearch={false}
        defaultOpen={0}
        accentColor="#fe9a00"
            ...
            <div className="bg-linear-to-br from-[#0f172b] to-[#1e293b] rounded-3xl p-8 lg:p-12">
              <div className="text-center max-w-3xl mx-auto">
                <h2 className="text-3xl lg:text-5xl font-black text-white mb-6">
                  Book Your Van Rental in Golders Green Today
                </h2>
                <p className="text-gray-300 text-xl mb-8 leading-relaxed">
                  Get the best rates on van hire in Golders Green. Whether you
                  need a van for a few hours or several weeks, we've got you
                  covered! Automatic vans available.
                </p>
