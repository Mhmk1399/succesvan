...
const faqData = [
  ...
  {
    question: "How do I book a van hire in Hampstead?",
    answer:
  ...
  {
    question: "What do I need to rent a van in Hampstead?",
    answer:
...
export default function HampsteadVanHire() {
  ...
  const testimonials = [
    {
      name: "James P.",
      rating: 5,
      text: "Fantastic service! Hired a van for a house move in Hampstead. The van was spotless and the whole process was seamless. Success Van Hire made moving day stress-free!",
      location: "Hampstead",
    },
    {
      name: "Emma W.",
      rating: 5,
      text: "Excellent van hire service in NW London. Competitive prices, friendly team, and well-maintained vehicles. I've used them multiple times for business deliveries.",
      location: "Golders Green",
    },
    {
      name: "Michael B.",
      rating: 5,
      text: "Needed a large van urgently for a furniture delivery. Success Van Hire had availability and sorted me out quickly. Great value and reliable service!",
      location: "Hendon",
    },
  ];
  ...
  // Service areas
  const serviceAreas = [
    { name: "Golders Green", link: "/van-hire-golders-green", featured: true },
  ...
  return (
    <>
      <Head>
        <title>Van Hire Hampstead | Success Van Hire - Cheap & Reliable NW London Van Rental</title>
        <meta
          name="description"
          content="Need van hire in Hampstead? Success Van Hire offers affordable van rental near Hampstead Heath. ULEZ compliant, no hidden fees, 5-star service. Book online or call 020 3011 1198."
        />
        <meta
          name="keywords"
          content="van hire hampstead, van rental hampstead london, hampstead van hire, nw london van rental, success van hire hampstead"
        />
        <link rel="canonical" href="https://www.successvanhire.com/van-hire-hampstead" />
      </Head>
    ...
    <div ref={sectionRef} className="relative w-full bg-[#0f172b] py-28">
      ...
      <section className="relative">
        ...
        <div className="relative w-full h-[50vh] sm:h-[60vh] lg:h-[70vh] overflow-hidden">
          ...
          <Image
            src="/assets/images/hampstead van hire.jpg"
            alt="Van Hire Hampstead - Success Van Hire modern fleet of vans in Hampstead"
            fill
            ...
            <div className="space-y-6 lg:space-y-8">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#fe9a00]/10 border border-[#fe9a00]/30 mb-4">
                  ...
                  <span className="text-[#fe9a00] font-bold text-xs sm:text-sm">HAMPSTEAD</span>
                </div>
              ...
              <div className="space-y-4">
                <p className="text-lg sm:text-xl text-gray-200 leading-relaxed">
                  Premium <strong className="text-white">van hire in Hampstead</strong> with Success Van Hire at competitive rates. Ideal for house removals, furniture delivery, business logistics, and IKEA collections. Need <Link href="/van-hire-london" className="text-[#fe9a00] hover:underline font-semibold">van hire London</Link>? We deliver <Link href="/cheap-van-hire-london" className="text-[#fe9a00] hover:underline font-semibold">cheap van hire London</Link> with premium service.
                </p>

                <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
                  Perfectly positioned near Hampstead Heath, serving all NW London areas with easy access. From compact vans for local deliveries to <Link href="/luton-van-hire-london" className="text-[#fe9a00] hover:underline font-semibold">Luton van hire London</Link> for complete house moves, our fleet meets every requirement. Looking for <Link href="/removal-van-hire-london" className="text-[#fe9a00] hover:underline font-semibold">removal van hire London</Link>? We offer flexible hourly, daily, weekly, and monthly <strong>Hampstead van hire</strong> options.
                </p>

                <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
                  As your local <strong>NW London van rental</strong> expert, we operate a modern fleet that's fully ULEZ and LEZ compliant. All vehicles receive regular servicing and professional cleaning. Select <strong>success van hire hampstead</strong> for dependable, professional van rental across North West London.
                </p>
              </div>
</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Your trusted partner for affordable van rental in Hampstead
            </p>
          </div>
      ...
      <section className="relative py-20 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Real feedback from satisfied van hire customers in Hampstead
            </p>
          </div>
      ...
      <section className="relative py-20 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-4">
              Serving <span className="text-[#fe9a00]">Hampstead</span> & Beyond
            </h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          ...
          <div className="mt-12 bg-blue-500/10 border border-blue-500/20 rounded-2xl p-6 text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-300">
              Our <strong>NW London van rental</strong> service extends across Hampstead, Golders Green, Hendon, Cricklewood, and all NW postcodes. Need a van in another area? Just ask – we offer delivery options and one-way rentals.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQComponent
        ...
        subtitle="Find answers to common questions about our van hire services in Hampstead"
        faqs={faqData}
        showSearch={false}
        defaultOpen={0}
        accentColor="#fe9a00"
            ...
            <div className="bg-linear-to-br from-[#0f172b] to-[#1e293b] rounded-3xl p-8 lg:p-12">
              <div className="text-center max-w-3xl mx-auto">
                <h2 className="text-3xl lg:text-5xl font-black text-white mb-6">
                  Book Your Van Rental in Hampstead Today
                </h2>
                <p className="text-gray-300 text-xl mb-8 leading-relaxed">
                  Get the best rates on van hire in Hampstead. Whether you need
