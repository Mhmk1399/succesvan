export const aboutUsSchema = {
  ...
  "@type": "AboutPage",
  name: "About Success Van Hire",
  url: "https://successvanhire.co.uk/aboutus",
  description:
    "Learn about Success Van Hire, London's trusted van rental company providing reliable and affordable van hire services.",
...
export const automaticVanHireSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Automatic Van Hire London",
  url: "https://successvanhire.co.uk/automatic-van-hire-london",
  description:
    "Automatic van hire in London by Success Van Hire. Easy-to-drive automatic transmission vans ideal for stress-free moving, deliveries, and city driving.",
  telephone: "+44 20 3011 1198",
  email: "Info@successvanhire.com",
  address: {
    "@type": "PostalAddress",
...
export const blogSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  name: "Success Van Hire Blog",
  url: "https://successvanhire.co.uk/blog",
  description:
...
export const contactSchema = {
  "@context": "https://schema.org",
  "@type": "ContactPage",
  name: "Contact Success Van Hire",
  url: "https://successvanhire.co.uk/contact-us",
  description:
...
export const ReservationPageSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Van Reservation - Success Van Hire",
...
export const VanHireBrentCrossSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Van Hire Brent Cross London - Success Van Hire",
  url: "https://successvanhire.co.uk/success-van-hire-van-rental-in-brent-cross-london-last-minute-bookings",
  description:
...
export const termsSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Van Hire Terms and Conditions - Success Van Hire",
  url: "https://successvanhire.co.uk/terms-and-conditions",
  description:
...
export const camdenFAQSchema = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "How do I book a van hire in Camden?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "What do I need to rent a van in Camden?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, all our vans meet EU6 emission standards and are part of our eco-friendly fleet. We are committed to environmental protection.",
      },
    },
  ],
};

export const cricklewoodFAQSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
    {
    ...
    {
      "@type": "Question",
      name: "How do I book a van hire in Cricklewood?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "You can book by sending your request on our website at www.successvanhire.co.uk/reservation/, sending us an email, or giving us a call on 020 3011 1198. Our booking process is quick and simple.",
      },
    ...
    {
      "@type": "Question",
      name: "What do I need to rent a van in Cricklewood?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "You need to provide: Your ID, a valid driving licences, proof of address, and your bank card. We accept full UK and EU driving licences with quick and easy verification.",
      },
