...
import { processFastAgent, createInitialFastState, getOfficesList, FastAgentState } from "@/lib/fast-agent";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const currentState: FastAgentState = clientState || createInitialFastState();
